...
class TilesPage extends StatefulWidget {
  ...
  static final model = PageItem(title: 'Tuiles', pageBuilder: (final context) => const TilesPage());
...
class _TilesPageState extends State<TilesPage> {
  ...
  Widget build(final context) => SingleChildScrollView(
    ...
    child: Column(
      ...
      spacing: 16,
      children: [
        Text('Tuile verticale', style: DsfrTextStyle.headline1(color: DsfrColorDecisions.textTitleGrey(context))),
        ...
        DsfrTile(
          ...
          details: 'Détail',
          badgesAndTags: [DsfrBadge(size: DsfrComponentSize.sm, label: 'badge info', type: DsfrBadgeType.information)],
          onTap: () {
        ...
        Container(
          ...
          child: DsfrTile(
            ...
            details: 'Détail',
            badgesAndTags: [
              DsfrBadge(size: DsfrComponentSize.sm, label: 'badge info', type: DsfrBadgeType.information),
            ],
            onTap: () {
              print('Tuile sm cliquée');
            },
        ...
        DsfrTile(
          ...
          badgesAndTags: [
            ...
            DsfrBadge(size: DsfrComponentSize.sm, label: 'badge 2', type: DsfrBadgeType.information),
            DsfrBadge(size: DsfrComponentSize.sm, label: 'badge 3', type: DsfrBadgeType.information),
          ],
          onTap: () {
            print('Tuile sm cliquée');
          },
        ...
        DsfrTile(
          ...
          description: 'Description',
          details: 'Détail',
          badgesAndTags: [DsfrBadge(size: DsfrComponentSize.md, label: 'badge info', type: DsfrBadgeType.information)],
          onTap: () {
        ...
        Container(
          ...
          child: DsfrTile(
            ...
            details: 'Détail',
            badgesAndTags: [
              DsfrBadge(size: DsfrComponentSize.md, label: 'badge info', type: DsfrBadgeType.information),
            ],
            onTap: () {
              print('Tuile md cliquée');
            },
        ...
        DsfrTile(
          ...
          badgesAndTags: [
            ...
            DsfrBadge(size: DsfrComponentSize.md, label: 'badge 2', type: DsfrBadgeType.information),
            DsfrBadge(size: DsfrComponentSize.md, label: 'badge 3', type: DsfrBadgeType.information),
          ],
          onTap: () {
            print('Tuile sm cliquée');
          },
        ...
        Text('Tuile horizontale', style: DsfrTextStyle.headline1(color: DsfrColorDecisions.textTitleGrey(context))),
        Text('Taille SM', style: DsfrTextStyle.headline2(color: DsfrColorDecisions.textTitleGrey(context))),
        DsfrTile(
          size: DsfrComponentSize.sm,
