  ...
  Widget build(final context) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        spacing: 16,
        children: [
          DsfrLink(label: 'lien taille SM', onTap: _handleTap, size: DsfrComponentSize.sm),
          DsfrLink(label: label, onTap: _handleTap, size: DsfrComponentSize.md),
          DsfrLink(label: 'lien taille LG', onTap: _handleTap, size: DsfrComponentSize.lg),
          const DsfrLink(label: 'lien désactivé (MD)'),
          DsfrLink(label: label, onTap: _handleTap),
          DsfrLink(label: label, icon: DsfrIcons.systemArrowLeftLine, onTap: _handleTap),
          DsfrLink(
            label: label,
