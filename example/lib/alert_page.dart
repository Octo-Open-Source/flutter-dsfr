...
class AlertPage extends StatelessWidget {
  ...
  static final model = PageItem(title: 'Alerte', pageBuilder: (final context) => const AlertPage());
  ...
  Widget build(final context) => ListView(
    ...
    children: [
      PageSubSection(
        title: 'Alerte avec titre et description',
        children: [
      ...
      PageSubSection(
        title: 'Alerte avec description seule',
        children: [
      ...
      DsfrAlertWithClose(),
      PageSubSection(
        title: 'Variantes : titre seul et description longue',
        children: [
          ...
          DsfrAlert(
            ...
            description: DsfrAlertDescriptionWidget(
              Column(
                ...
                children: [
                  Text('Description'),
                  DsfrLink(label: 'linklabel', onTap: () {}, size: DsfrComponentSize.md),
                ],
              ),
            ),
          ),
...
class _DsfrAlertWithCloseState extends State<DsfrAlertWithClose> {
  ...
  Widget build(final context) {
    return PageSubSection(
      title: 'Alerte avec icône de fermeture',
      children: [
        if (isInfoVisible)
          DsfrAlert(
            type: DsfrAlertType.info,
