      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Expanded(
                child: DsfrInput(label: 'Input', onChanged: (final value) {}),
              ),
              Expanded(
                child: DsfrInput(label: 'Input - désactivé', onChanged: (final value) {}, enabled: false),
              ),
            ],
          ),
          ...
          DsfrInput(label: 'Mot de passe', onChanged: print, isPasswordMode: true),
          DsfrInput(label: 'Password', onChanged: print, isPasswordMode: true, displayPasswordLabel: 'Show'),
          DsfrInput(label: 'Input password - désactivé', onChanged: print, isPasswordMode: true, enabled: false),
          DsfrInput(
            label: 'Input - error',
            onChanged: print,
