...
class DsfrAccordion {
  const DsfrAccordion._({required this.headerBuilder, required this.body});

  DsfrAccordion({required final String headerLabel, final String? headerExpandedLabel, required final Widget body})
    : this._(
