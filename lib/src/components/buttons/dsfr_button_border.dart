...
class DsfrButtonBorder extends WidgetStateProperty<Border> {
  DsfrButtonBorder({required final Border $default, required final Border disabled})
    : _default = $default,
      _disabled = disabled;

  factory DsfrButtonBorder.fromVariant(final DsfrButtonVariant variant, final BuildContext context) {
    switch (variant) {
      ...
      case DsfrButtonVariant.secondary:
        return DsfrButtonBorder(
          $default: Border.fromBorderSide(BorderSide(color: DsfrColorDecisions.borderActionHighBlueFrance(context))),
      ...
      case DsfrButtonVariant.tertiary:
        return DsfrButtonBorder(
          $default: Border.fromBorderSide(BorderSide(color: DsfrColorDecisions.borderDefaultGrey(context))),
          disabled: Border.fromBorderSide(BorderSide(color: DsfrColorDecisions.borderDisabledGrey(context))),
        );
    }
  }
